    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">İcerik Düzenle</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-md-4">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12">
                                                <img class="rounded avatar-lg" src="{{(!empty($icerikler->resim))? url($icerikler->resim): url('upload/görseli_hazrilaniyor.png')}}" alt="" id="resimGoster">
                                            </div>
                                        </div>
                                        <!-- Resim -->
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12 form-group">
                                                <input class="form-control" name="anahtar" type="text" placeholder="Kategori Anahtar..." value="{{$icerikler->anahtar}}">
                                            </div>
                                        </div>
                                        <!-- Anahtar -->
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12 form-group">
                                                <input class="form-control" name="aciklama" type="text" placeholder="Kategori Acıklama..." value="{{$icerikler->aciklama}}">
                                            </div>
                                        </div>
                                        <!-- Acıklama -->
                                    ...
                                    <input type="submit" class="btn btn-info waves-effect wave-light" value="Blog İcerik Güncelle">
                                </div>
                                <!-- Row Bitiş -->
